<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MTClientCompanyDetails.aspx.cs" Inherits="MTClientCompanyDetails" %>
...
<body dir="<%=strType %>" style="background-image:url(Images/backgroundImg.jpg); background-repeat :repeat ; background-position: center center; background-attachment: scroll;">
    <form id="frmMTClientCompany" runat="server" dir="<%=strType %>">
        <div align="center">
            <table>
                <tr>
                    <td class="divCircle">
                        <table class="MyTableBorder">
                            <tr>
                                <td class="MyTableHeader" colspan="4" align="center">
                                    <asp:Label ID="lblSchoolInformation" runat="server" Text="Client Company Details" CssClass="MyLableHeader"></asp:Label>&nbsp;</td>
                            ...
                            <tr>
                                <td align="right" class="MyLabel" valign="top">
                                    <asp:Label ID="lblCity" runat="server" Text="Contact Person" CssClass="MyLabel" Width="90px"></asp:Label></td>
                                <td align="left">
                                ...
                                <td align="right" class="MyLabel">
                                    <asp:Label ID="lblPinCode" runat="server" Text="Title" CssClass="MyLabel" Width="100px"></asp:Label></td>
                                <td align="left">
                            ...
                            <tr>
                                <td align="right" class="MyLabel" valign="top">
                                    <asp:Label ID="lblState" runat="server" Text="Mobile" CssClass="MyLabel" Width="90px"></asp:Label></td>
                                <td align="left">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtAffiliation" runat="server" CssClass="MyTextBox" TabIndex="10" Width="200px"
                                        MaxLength="60"></asp:TextBox></td>
                                <td align="right" class="MyLabel">
                                    <asp:Label ID="lblMedium" runat="server" CssClass="MyLabel" Text="TRN" Width="100px"></asp:Label></td>
                                <td align="left">
                            ...
                            <tr id="trBankacc" style="display:none;">
                                <td align="right" class="MyLabel" valign="top">
